 ...
 */
@MapperScan(basePackages = {"com.linkkou.mybatis.orm.**.dao"}, sqlSessionTemplateRef = EnableDataSourceImpl.MAPPER_SCANNER_CONFIGURER)
public class EnableDataSourceImpl {

    public static final String MAPPER_LOCATION = "classpath*:com/linkkou/mybatis/orm/**/*Mapper.xml";
    ...
    public DataSource buildDataSource(@Value("${datasource.url}") String url,
                                      @Value("${datasource.username}") String username,
                                      @Value("${datasource.password}") String password) throws SQLException {
